...
#sonido-chat-balloon{position:fixed;bottom:calc(${BOTTOM} + 12px);right:calc(${RIGHT} + 70px);background:#fff;border:1px solid #e0e0e0;border-radius:12px 12px 0 12px;padding:8px 14px;font-size:13px;color:#333;white-space:nowrap;box-shadow:0 2px 8px rgba(0,0,0,.12);z-index:9997;animation:balloon-in .3s ease}
